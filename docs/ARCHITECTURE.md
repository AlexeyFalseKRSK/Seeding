...
| `models/bestKlassSegFlip180.pt` | локальный файл | **Классификация частей** (текущий дефолт): корень, стебель, соцветие и др. с масками |
| `models/bestKlassSeg.pt` / `models/bestKlassSegNew.pt` | локальные файлы | Старые/альтернативные версии классификатора |
